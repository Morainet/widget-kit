...
import net.morainet.widget.core.WidgetPinHelper
import net.morainet.widget.debugger.WidgetDebugSnapshot
import net.morainet.widget.debugger.WidgetDebuggerPanel
import net.morainet.widget.debugger.WidgetInspector
import net.morainet.widget.preview.WidgetPreviewHost
import net.morainet.widget.preview.WidgetPreviewSizes
import net.morainet.widget.sample.widget.CounterWidgetContent
import net.morainet.widget.sample.widget.CounterWidgetReceiver
...
class MainActivity : ComponentActivity() {
    ...
    private fun seedDebuggerSnapshots() {
        WidgetInspector.record(
            WidgetDebugSnapshot(
                widgetId = 1,
                widgetClass = "net.morainet.widget.sample.widget.CounterWidget",
                remoteViewTree = null,
        ...
        WidgetInspector.record(
            WidgetDebugSnapshot(
                widgetId = 2,
                widgetClass = "net.morainet.widget.sample.widget.WeatherWidget",
                remoteViewTree = null,
                lastUpdatedAt = System.currentTimeMillis(),
