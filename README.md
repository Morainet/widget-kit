...
| 模块 | 说明 | 状态 |
|------|------|------|
| `widget-core` | 生命周期、批量更新、Action 路由 | 🚧 Phase 1 |
| `widget-state` | `loading / success / error` 状态机 | 🚧 Phase 1 |
| `widget-workmanager` | WorkManager 周期/事件刷新封装 | 🚧 Phase 1 |
| `widget-animation` | 动画预设与双路径降级 | 🚧 Phase 1 |
| `widget-preview` | `@WidgetPreview` 多尺寸预览 | 🚧 Phase 1 |
| `widget-debugger` | RemoteViews 树与 PendingIntent 检查 | 🚧 Phase 1 |
| `widget-dsl` | YAML/JSON Schema → Glance 渲染 | 🚧 Phase 1 末期 |
| `sample` | 参考实现与集成示例 | 🚧 Phase 1 |
